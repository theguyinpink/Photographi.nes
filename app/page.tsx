        ...
        <div className="px-8 py-14 sm:px-14 sm:py-20">
          ...
          <div className="mt-10 max-w-4xl">
            ...
            <div className="mt-12 flex flex-wrap items-center gap-4">
              ...
              <Link
                href="/cart"
                className="inline-flex items-center justify-center rounded-2xl border border-black/10 bg-white px-6 py-3 text-sm font-semibold text-black/80 hover:bg-black/3 transition"
              >
                Voir le panier
              </Link>
